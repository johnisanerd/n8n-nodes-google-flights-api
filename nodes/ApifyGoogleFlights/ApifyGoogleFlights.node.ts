...
import { properties } from './ApifyGoogleFlights.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = '1dYHRKkEBHBPd0JM7' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-flights-api' as string;
export const CLASS_NAME = 'ApifyGoogleFlights' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-flights-app' as string;

export const DISPLAY_NAME = 'Google Flights' as string;
export const DESCRIPTION =
	'Search flights and fares by route and date, returning airlines, times, durations, stops, and prices' as string;

export class ApifyGoogleFlights implements INodeType {
